...
const TransactionHistoryCard = ({ isReceived }) => {
   return (
      <div className="flex items-center justify-between gap-6">
         <div className="space-y-1">
            <p className="text-[#222222] text-base font-semibold">+88012365554</p>
            <p className="text-[#6B6B6B] font-normal text-xs ps-1">Abdul Wahid</p>
         </div>
