...
const TaskCard = ({ task, index = 0 }) => {
   ...
   return (
      <div className="flex py-2 border border-slate-200 px-3 rounded-[8px] flex-col  lg:flex-row w-full lg:gap-10 gap-4 justify-between">
         <div className="flex-1 w-full max-w-3xl justify-between  flex items-center flex-col gap-8 lg:flex-row ">
            ...
            <Badge className="bg-red-700 hover:bg-red-600 text-white">Overdue</Badge>
         </div>
         <div className="flex items-center gap-2">
            <button onClick={handleEdit} className="flex items-center gap-1.5 px-2 py-2 hover:bg-gray-100 text-gray-700 rounded-md" type="button">
               <Pencil size={16} className="text-gray-800" />
               <span>Edit</span>
            </button>
            <button onClick={handleDelete} className="flex items-center gap-1.5 px-2 py-2 hover:bg-gray-100 text-gray-700 rounded-md" type="button">
