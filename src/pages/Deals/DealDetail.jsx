...
import { Building2, Users, FileText, CheckSquare, DollarSign, Briefcase, MapPin, ArrowLeft, MessageSquarePlus, FileCheck, SquareUserRound, Edit3, Trash2, BookLock, FileSymlink, Eye } from 'lucide-react';
...
import DealClients from './DealClients';
...
const DealDetail = () => {
   ...
   return (
      <div className="  pt-1 pb-6 flex gap-6 items-start">
         ...
         <div className='flex-1 space-y-6 lg:ps-[150px]'>
            ...
            <div className='bg-white py-3 rounded-[8px] px-3 flex flex-col lg:flex-row gap-4'>
               ...
               <Secure userType={["admin"]}>
                  <Button onClick={() => setIsAddTask(true)} className="w-full gap-2 text-title hover:bg-transparent hover:text-blue-600" variant="ghost"> <FileCheck size={16} /> Add Task</Button>
               </Secure>
            ...
            <Tabs defaultValue="notes" className="w-full">
               ...
               {/* note  */}
               <TabsContent className="min-h-[30vh]" value="notes">
                  <div className=''>
               ...
               <TabsContent className="min-h-[30vh]" value="tasks">
                  <TaskTab dealId={id} />
               </TabsContent>


               {/* related contact  */}
               <TabsContent className="min-h-[30vh]" value="contacts">
                  <Card>
                     <CardHeader>
               ...
               <TabsContent className="min-h-[30vh]" value="history">
                  <Card>
                     <CardHeader>
                     ...
                     <CardContent>
                        {dealDetails.related_contact.length === 0 ? (
                           <p className="text-muted-foreground text-center py-4">No Activity log.</p>
                        ) : (
                           <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                              {dealDetails.related_contact.map(contact => (
                                 <Card key={contact.id}>
         ...
         <AddTask isOpen={isAddTask} setOpen={setIsAddTask} dealId={id} />
