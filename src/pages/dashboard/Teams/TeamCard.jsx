      ...
      <div className="w-full bg-white flex p-5 border-s-2   overflow-hidden rounded-[16px] ">
         <div className="flex flex-col w-full">
            <div className="mb-4 flex items-center gap-5">
               <h3 onClick={handleDetails} className="text-lg hover:underline cursor-pointer hover:text-blue-700 flex-1 line-clamp-1 font-semibold text-title ">
                  {team?.name}
               </h3>
               <div className="">
            ...
            <div className="flex items-end gap-4 w-full">
               <div className="flex-1">
                  ...
                  <div className="flex -space-x-3 mt-2">
                     {team?.user?.slice(0, 3).map((pr, index) => {
